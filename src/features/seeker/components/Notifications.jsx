...
import {
  ...
  deleteNotification,
} from "@/features/seeker/api/seeker";
...
export function Notifications() {
  ...
  const markAllMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["seeker-notifications"] });
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mb-4 flex items-center gap-3">
        ...
        <button
          onClick={() => queryClient.invalidateQueries({ queryKey: ["seeker-notifications"] })}
